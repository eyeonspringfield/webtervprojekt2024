...
<main>
  ...
  <div class="autobox">
    <img src="../img/mercedes-benzg550.jpg" alt="auto kép" height="250">
    <p>Ehhez a luxusautóhoz most jóval a kereskedelmi ár alatt férhet hozzá! Hatósági árverezésen került beszerzésre. Nem rendelkezik forgalmi engedéllyel.</p>
    <br>
    <ul>
      <li>4.0-es V8 biturbo motor</li>
      <li>67000 km</li>
      <li>Elképesztő 416 lóerős teljesítmény</li>
      <li>Modern infotainment berendezés, Apple CarPlay és Android Auto támogatott</li>
      <li>Beszerzési árhoz képest jóval alacsonyabb áron</li>
    </ul>


    <p id="price">12 999 990 HUF</p>

      <?php
      if(isset($_SESSION["user"])){
          load_likes_logged_in($_SESSION["user"], 3);
      }else {
          load_likes(3);
      }
      ?>
    ...
    <br>
      ...
      if(isset($_POST["appointment"])){
          addAppointment($_SESSION["user"]["username"], "Mercedes-Benz G550 2020", $_POST["appointmentdate"]);
      }
      if(isset($_SESSION["user"])) {
      ...
      if(isset($_SESSION["user"]) && $_SESSION["user"]["admin"]) {
          ...
          echo'<input type="hidden" name="article_id" value="3">';
