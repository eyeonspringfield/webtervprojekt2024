...
<main>
  ...
  <div class="autobox">
    <img src="../img/fordfocus.jpg" alt="auto kép" height="250">
    <p>Ez a Ford Focus igazán hasznos legyen szó nagyutazásról, vagy szerszámok, építőanyagok szállításáról. Rendelkezik forgalmi engedéllyel.</p>
    <br>
    <ul>
      <li>1.6-os benzin motor</li>
      <li>224000 km</li>
      <li>Alacsony fogyasztás</li>
      <li>Bluetooth, AUX rádió</li>
      <li>Alacsony áron</li>
    </ul>


    <p id="price">1 099 990 HUF</p>

      <?php
      if(isset($_SESSION["user"])){
          load_likes_logged_in($_SESSION["user"], 2);
      }else {
          load_likes(2);
      }
      ?>
    ...
    <br>
      ...
      if(isset($_POST["appointment"])){
          addAppointment($_SESSION["user"]["username"], "Ford Focus 2004", $_POST["appointmentdate"]);
      }
      if(isset($_SESSION["user"])) {
      ...
      if(isset($_SESSION["user"]) && $_SESSION["user"]["admin"]) {
          ...
          echo'<input type="hidden" name="article_id" value="2">';
